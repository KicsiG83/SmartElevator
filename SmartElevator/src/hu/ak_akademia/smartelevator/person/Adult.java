...
public class Adult extends Resident {
    ...
    public Adult(Name name, int ageInYears, int weightInKilograms, Occupation occupation, Scale speedInKilometersPerHour, List<AbsenceTime> absenceTimes, Scale patience) {
