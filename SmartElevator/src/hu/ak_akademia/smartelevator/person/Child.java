...
public class Child extends Resident {
    ...
    public Child(Name name, int ageInYears, int weightInKilograms, Occupation occupation, Scale speedInKilometersPerHour, List<AbsenceTime> absenceTimes, Scale patience) {
